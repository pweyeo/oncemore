...
lead: "Learn about the thinking behind ABP Chromium."
draft: false
images: []
menu:
  docs:
...
This page contains ABP Chromium's architectural decision records **(ADRs)**, which summarize the most important software design choices made during the development of Adblock Plus Chromium.
...
We can now use full filter list, which allow for more filter rules. This improves user experience and blocks a greater number of intrusive ads. As a result, more acceptable ads are allowed, which increases for publishers who participate in the [Acceptable Ads scheme](https://acceptableads.com/).
...
Do you have questions about other architectural decisions made during the development of ABP Chromium? Contact eyeo's team for answers. [Support →]({{< relref "#" >}})
